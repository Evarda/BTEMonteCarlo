...
subroutine makeScatTable
   ...
   ! ScatteringTable(Initial Valley, Energy, Rate #)
    ...
    do ii = 1, nE
        write (70, *) ScatteringTable(3, ii,  1)
        write (71, *) ScatteringTable(3, ii,  2)
        write (72, *) ScatteringTable(3, ii,  3)
        write (73, *) ScatteringTable(3, ii,  4)
        write (74, *) ScatteringTable(3, ii,  5)
        write (75, *) ScatteringTable(3, ii,  6)
        write (76, *) ScatteringTable(3, ii,  7)
        write (77, *) ScatteringTable(3, ii,  8)
        write (78, *) ScatteringTable(3, ii,  9)
        write (79, *) ScatteringTable(3, ii, 10)
    enddo
    close(70)
    close(71)
    close(72)
